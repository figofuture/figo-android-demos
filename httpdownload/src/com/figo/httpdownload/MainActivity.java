...
import com.figo.httpdownload.entity.LoadInfo;
import com.figo.httpdownload.service.Downloader;
...
import android.widget.Toast;
 ...
 public class MainActivity extends ListActivity { 
     ...
     private static final String URL = "http://dl.google.com/android/adt/";
     // 固定存放下载的音乐的路径：SD卡目录下
	...
	private Handler mHandler = new Handler() {
     ...
     private void showListView() {
         ...
         map.put("name", "adt-bundle-windows-x86-20130219.zip");
         data.add(map);
         map = new HashMap<String, String>();
         map.put("name", "adt-bundle-windows-x86_64-20130219.zip");
         data.add(map);
         map = new HashMap<String, String>();
         map.put("name", "adt-bundle-linux-x86-20130219.zip");
         data.add(map);
         map = new HashMap<String, String>();
         map.put("name", "adt-bundle-linux-x86_64-20130219.zip");
         data.add(map);
     ...
     public void startDownload(View v) {
         ...
         String localfile = SD_PATH + File.separator + resouceName;
    ...
    class DownloadTask extends AsyncTask<String, Integer, LoadInfo>{
     ...
     private void showProgress(LoadInfo loadInfo, String url, View v) {
         ...
         if (bar == null) {
             ...
             LinearLayout.LayoutParams params = new LayoutParams(LayoutParams.MATCH_PARENT, 5);
