...
public class PowerProfile {
	...
	/**
	 * Returns the battery capacity, if available, in milli Amp Hours. If not
	 * available, it returns zero.
	 * 
	 * @return the battery capacity in mAh
	 */
	public double getBatteryCapacity() {
		try {
			return (Double) CLASS.getMethod("getBatteryCapacity").invoke(mThis);
		} catch (Exception e) {
			e.printStackTrace();
			Log.e(LOG_TAG, e.getMessage());
		}
